...
const file = '/Users/mayankrathi/Downloads/Business Idea Prototypes/play-store-apps/apps.bhopal.dev/tambola/src/tambolaPhrases.js';
let content = fs.readFileSync(file, 'utf8');

const regex = /export const LANGUAGES = \{[\s\S]*?\n\};\n\n\/\*\*/m;
const newLangDef = `export const LANGUAGES = {
    en: {
        label: 'English',
        flag: '🇬🇧',
        code: 'en-US',
...
content = content.replace(regex, newLangDef);
fs.writeFileSync(file, content);
console.log('Phrases correctly updated in tambolaPhrases.js!');
